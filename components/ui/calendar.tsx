        ...
        <DayPicker
            ...
            classNames={{
                ...
                day: cn(
                    ...
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-white/20 text-white"
                ),
                day_range_end: "day-range-end",
                day_selected:
                    "bg-[#7A6E7D] text-primary-foreground hover:bg-[#7A6E7D] hover:text-primary-foreground focus:bg-[#7A6E7D] focus:text-primary-foreground",
