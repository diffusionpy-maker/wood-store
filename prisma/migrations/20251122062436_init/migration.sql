...
-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('ecpay', 'linepay');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('requested', 'reserved', 'confirmed', 'failed', 'refunded');
...
CREATE TABLE "Order" (
    ...
    "paymentStatus" "PaymentStatus" NOT NULL DEFAULT 'requested',
