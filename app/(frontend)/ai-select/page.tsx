      ...
      <section className="relative py-24 lg:py-40">
        <div className="container mx-auto px-4 text-center relative z-10">
          <ScrollReveal>
            ...
            <span className="text-xs font-semibold text-primary/80 tracking-[0.25em] uppercase group-hover:tracking-[0.35em] transition-all duration-500">AI Intelligent Selection</span>
          </div>
          </ScrollReveal>
